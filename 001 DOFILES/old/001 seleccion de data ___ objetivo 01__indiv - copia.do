...
keep conglome vivienda hogar codperso ubigeo dominio estrato nc lw  lwage  sec_ocu  nempljh  act_empr  ocupinf sector_econ race inc_finc funcion  acceso_financiero   fac* ocupinf ocu500 yea*
...
keep conglome vivienda hogar ubigeo dominio estrato   ag_pot  enerlectr  interne   prop_viv  tit_prop  sunarp  urban  zone  nbi*  fac*
...
foreach year of numlist 2020/2022 {
use "$mod1\enaho01a-`year'-100.dta", clear
