...
label data "Modulo: EMPELO E INGRESOS - ENAHO Panel 2018-2022"
...
merge 1:m conglome* vivienda* hogar* codperso* using "$dclea/mod500_panel_2022.dta" , nogen
	...
	rename a*o_19 año_19
	rename a*o_18 año_18
...
generate dpto_ = real(substr(ubigeo_, 1,2))
...
*use "$dclea/pobreza_panel_18-22.dta", clear 
save "$dclea/pobreza_panel_18-22_v2.dta", replace
