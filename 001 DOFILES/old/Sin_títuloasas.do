...
global X_static lwage_   totmieho_  internet_ 
************************************************************
...
* Quitar la constante de la colección
*collect drop colname[_cons]
...
*--------------------------------------------------------------*
* 3.3. Diseño de la tabla: una fila por variable, columnas = modelos
*    (solo dy/dx; si quieres también errores estándar, ver opción comentada)
*--------------------------------------------------------------*

* Solo efectos marginales (dy/dx)
collect layout (colname) (result[_r_b]#model)

* Si quieres coeficiente y error estándar:
