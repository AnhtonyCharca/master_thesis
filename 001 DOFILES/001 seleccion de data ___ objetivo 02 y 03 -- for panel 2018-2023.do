...
tab pob_monetaria, missing
tab pobre_multi,   missing

*--------------------------------------------------------------*
* Pobreza integrada: monetaria + multidimensional
* (tipología análoga a INEI, pero con pobre_multi)
*--------------------------------------------------------------*
capture drop pob_int_multi
gen byte pob_int_multi = .

* 1 = Crónicos (pobre monetario y multidimensional)
replace pob_int_multi = 1 if pob_monetaria==1 & pobre_multi==1

* 2 = Estructurales (no pobre monetario, sí multidimensional)
replace pob_int_multi = 2 if pob_monetaria==0 & pobre_multi==1

* 3 = Coyunturales (pobre monetario, no multidimensional)
replace pob_int_multi = 3 if pob_monetaria==1 & pobre_multi==0

* 4 = Integrados (no pobre monetario ni multidimensional)
replace pob_int_multi = 4 if pob_monetaria==0 & pobre_multi==0

label define pob_int_multi_lbl ///
...
label values pob_int_multi pob_int_multi_lbl
label var pob_int_multi "Pobreza integrada: monetaria + multidimensional"

* Dummy global: pobre en alguna dimensión
capture drop pobre_integrada_multi
gen byte pobre_integrada_multi = (pob_monetaria==1 | pobre_multi==1)
label var pobre_integrada_multi "Pobre en al menos una dimensión (monetaria o multidimensional)"

rename pobre_integrada  pobre_clas_integrada 
rename pob_int_multi pobre_integrada
